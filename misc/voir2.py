...
pd.set_option("display.max_rows", None, "display.max_columns", None,"display.width",shutil.get_terminal_size().columns)
...
def read_headers (filename):
  ...
  df = pd.DataFrame(out)
  df = df[['nomvar','typvar','etiket','ni','nj','nk','dateo','ip1','ip2','ip3','deet','npas','datyp','nbits','grtyp','ig1','ig2','ig3','ig4','datev','dltf','key']]
