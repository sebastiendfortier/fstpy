...
def get_dataframe_sorted_by_date():
    df = fstpy.StandardFileReader('/home/spst900/spooki/spooki_dir/pluginsRelatedStuff/testsFiles/fstpy_hovmoller_VV_250hPa_RU_0.3d',decode_metadata=True,query='nomvar=="VV"').to_pandas()
