...
def get_df_from_grid(grid_params:dict) -> pd.DataFrame:
    ...
    if (g['grtyp'] == 'Z') or (g['grtyp'] == 'Y'):
        meta_df = pd.DataFrame([{'nomvar':'>>', 'typvar':'X', 'etiket':'', 'ni':g['ni'], 'nj':1, 'nk':1, 'dateo':0, 'ip1':g['ig1'], 'ip2':g['ig2'], 'ip3':0, 'deet':0, 'npas':0, 'datyp':5, 'nbits':32, 'grtyp':g['grref'], 'ig1':g['ig1ref'], 'ig2':g['ig2ref'], 'ig3':g['ig3ref'], 'ig4':g['ig4ref'], 'datev':0, 'd':g['ax']},
                            {'nomvar':'^^', 'typvar':'X', 'etiket':'', 'ni':1, 'nj':g['nj'], 'nk':1, 'dateo':0, 'ip1':g['ig1'], 'ip2':g['ig2'], 'ip3':0, 'deet':0, 'npas':0, 'datyp':5, 'nbits':32, 'grtyp':g['grref'], 'ig1':g['ig1ref'], 'ig2':g['ig2ref'], 'ig3':g['ig3ref'], 'ig4':g['ig4ref'], 'datev':0, 'd':g['ay']} ])
    elif g['grtyp'] == 'U':
        meta_df = pd.DataFrame([{'nomvar':'^>', 'typvar':'X', 'etiket':'', 'ni':g['axy'].shape[0], 'nj':1, 'nk':1, 'dateo':0, 'ip1':g['ig1'], 'ip2':g['ig2'], 'ip3':0, 'deet':0, 'npas':0, 'datyp':5, 'nbits':32, 'grtyp':g['grref'], 'ig1':g['ig1ref'], 'ig2':g['ig2ref'], 'ig3':g['ig3ref'], 'ig4':g['ig4ref'], 'datev':0, 'd':g['axy']}])
    else:
